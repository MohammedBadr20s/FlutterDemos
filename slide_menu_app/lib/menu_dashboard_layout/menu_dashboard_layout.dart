...
import 'package:slide_menu_app/menu_dashboard_layout/dashboard.dart';
...
class _MenuDashboardLayoutState extends State<MenuDashboardLayout>
    with SingleTickerProviderStateMixin, NavigationStates {
                ...
                BlocBuilder<NavigationBloc, NavigationStates>(
                  builder: (context, NavigationStates navigationState) {
                    return Menu(
                      ...
                      selectedIndex: findSelectedIndex(navigationState: navigationState),
